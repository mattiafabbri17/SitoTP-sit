...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'avanzamentoSito_3b336a6b9fa540968690_20251107095509_archive.zip';
        const ARCHIVE_SIZE       = '86234462';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '3b336a6-07095509';
        const SECONDARY_PACKAGE_HASH = 'adec6d2-07095509';
