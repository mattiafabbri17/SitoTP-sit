...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'terminazioneSito_453a5060e6afe44b8271_20251114095843_archive.zip';
        const ARCHIVE_SIZE       = '96802018';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '453a506-14095843';
        const SECONDARY_PACKAGE_HASH = '1b25236-14095843';
